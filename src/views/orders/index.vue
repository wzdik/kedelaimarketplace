...
<template>
    <div class="container mt-5 mb-5 gradient-bg">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <router-link :to="{ name: 'orders.create' }" class="btn btn-md btn-success rounded shadow gradient-btn mb-4">
                            ...
                            <tbody>
                                ...
                                <tr v-else v-for="(order, index) in orders" :key="index">
                                    ...
                                    <td class="text-center">
                                        <router-link :to="{ name: 'orders.edit', params:{id: order.id} }" class="btn btn-sm rounded-sm shadow gradient-btn me-2">
                                            <i class="fas fa-edit"></i> EDIT
                                        </router-link>
                                        <button @click.prevent="deleteorders(order.id)" class="btn btn-sm rounded-sm shadow btn-danger gradient-btn">
